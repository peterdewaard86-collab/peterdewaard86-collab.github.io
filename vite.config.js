  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        scope: "/",
        icons: [
          { src: "https://bullss-bearss.netlify.app/icon-192.png", sizes: "192x192", type: "image/png" },
          { src: "https://bullss-bearss.netlify.app/icon-512.png", sizes: "512x512", type: "image/png" },
          { src: "https://bullss-bearss.netlify.app/icon-maskable-512.png", sizes: "512x512", type: "image/png", purpose: "maskable" }
        ]
      },
      workbox: {
